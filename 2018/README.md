...
This is my [Advent of Code 2018](https://adventofcode.com/2018) repository. I will push all of my code to here, and I might even include `README.md` files with explanations if I feel inclined.
...
All code is designed to be run at root of each year. In this case, inside the top level of `2018/`. Each day has `part_1.py` and `part_2.py`. For example,
